            ...
            <div className="container">
                    ...
                    <div className="slide-feedback owl-carousel owl-theme" style={{opacity: '1', display: 'block'}}>
                            ...
                            <div className="owl-item" style={{width: '550px'}}><div className="item">
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/277447485-1527578253097-screenshot2018-05-29at14.16.21.png"/>
                            ...
                            </div></div><div className="owl-item" style={{width: '550px'}}><div className="item">
                                <div className="des-feddback frame-des">
                                    <p className="dot-4">
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/865595390-1527577570113-tshai.png"/>
                                    <div className="director-name">
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/928707584-1527644208516-capture.png"/>
                                    <div className="director-name">
                                        <p>Võ Khắc Minh</p>
                                        <p></p>
                ...
                <div className="col col-xs-12 col-sm-6 feedback-parent-panel-2">
                    ...
                    <div className="slide-feedback owl-carousel owl-theme" style={{opacity: '1', display: 'block'}}>
                            ...
                            <div className="owl-wrapper-outer"><div className="owl-wrapper" style={{width: '3300px', left: '0px', display: 'block', transition: 'all 1000ms ease', transform: 'translate3d(0px, 0px, 0px)'}}><div className="owl-item" style={{width: '550px'}}><div className="item">
                                <div className="des-feddback frame-des">
                                    <p className="dot-5">
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/368890267-1526321545170-img_9430_fotor.jpg"/>
                                    <div className="director-name">
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/440464067-1527571303328-screenshot2018-05-29at12.18.52.png"/>
                                    <div className="director-name">
                                        <p>Lương Mạnh Hải</p>
                                        <p>Trường Đại học Thương Mại</p>
                                    </div>
                                ...
                                <div className="director-info">
                                    <img className="director-avatar" src="http://storage.googleapis.com/kslearning/images/566506346-1527569787561-oanhtrần.png"/>
                                    <div className="director-name">
                                        <p>Nguyễn Hải Yến</p>
