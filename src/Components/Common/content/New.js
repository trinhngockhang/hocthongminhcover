        ...
        return(
            ...
            <div className="container">
                <div id="slider-news" style={{position: 'relative', opacity: '1', display: 'block'}} className="owl-carousel owl-theme">
                        ...
                        </div></div><div className="owl-item" style={{width: '285px'}}><div className="item" style={{cursor: 'pointer'}} onclick="window.open('/tin-tuc/huong-dan-thanh-toan-cho-hoc-thong-minh')">
