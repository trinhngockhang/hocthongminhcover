...
var DropdownItemSelectionManager = function (_Component) {
  ...
  function DropdownItemSelectionManager() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DropdownItemSelectionManager.__proto__ || _Object$getPrototypeOf(DropdownItemSelectionManager)).call.apply(_ref, [this].concat(args))), _this), _this.setItemSelected = function (itemId, isSelected, defaultSelected) {
