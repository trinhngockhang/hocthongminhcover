...
var DropdownMenuStateless = function (_Component) {
  ...
  function DropdownMenuStateless() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DropdownMenuStateless.__proto__ || _Object$getPrototypeOf(DropdownMenuStateless)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      id: uuid()
