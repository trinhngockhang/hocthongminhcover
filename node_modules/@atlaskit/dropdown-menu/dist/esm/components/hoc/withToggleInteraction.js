...
var withToggleInteraction = function withToggleInteraction(WrappedComponent, SelectionIcon, ariaRole) {
  var WithToggleInteraction = function (_Component) {
    ...
    function WithToggleInteraction() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WithToggleInteraction.__proto__ || _Object$getPrototypeOf(WithToggleInteraction)).call.apply(_ref, [this].concat(args))), _this), _this.getIconColors = function () {
