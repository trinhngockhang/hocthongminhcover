...
var Item = function (_PureComponent) {
  ...
  function Item() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Item.__proto__ || _Object$getPrototypeOf(Item)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      isHovered: false,
      isPressed: false
