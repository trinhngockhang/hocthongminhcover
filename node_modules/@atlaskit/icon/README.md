...
![Example icon](https://bytebucket.org/atlassian/atlaskit/raw/0d4e0cc8249056dae7bdafcd970efb7ae9418d76/packages/icon/docs/icon.png)

## Try it out

Interact with a [live demo of the @atlaskit/icon component.](https://aui-cdn.atlassian.com/atlaskit/stories/@atlaskit/icon/9.0.1/)
