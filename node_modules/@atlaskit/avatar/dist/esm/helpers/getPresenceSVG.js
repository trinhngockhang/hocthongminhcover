...
var BusyCircle = styled.circle(_templateObject, themed({ light: colors.R300, dark: colors.R200 }));
var BusyPath = styled.path(_templateObject, colors.background);
var FocusPath = styled.path(_templateObject, colors.purple);
var OfflineOuter = styled.path(_templateObject, themed({ light: colors.N200, dark: colors.DN100 }));
var OfflineInner = styled.path(_templateObject, themed({ light: colors.N40, dark: colors.DN500 }));
var OnlineCircle = styled.circle(_templateObject, themed({ light: colors.G300, dark: colors.G200 }));
